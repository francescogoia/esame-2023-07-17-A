...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._ddColore = ft.Dropdown(label="Colore", width=400)
        self.btn_graph = ft.ElevatedButton(text="Crea Grafo", on_click=self._controller.handle_graph, width=200)

        self._controller.fillDDColore()

        row2 = ft.Row([self._ddColore, self.btn_graph], alignment=ft.MainAxisAlignment.CENTER)
